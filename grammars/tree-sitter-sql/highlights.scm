(object_reference
  name: (identifier) @support.type.sql)

(invocation
  (object_reference
    name: (identifier) @support.other.function.sql))
...
[
  ...
  (keyword_array)
  (keyword_object_id)
] @support.other.function.sql

(relation
  alias: (identifier) @variable.other.sql)

(field
  name: (identifier) @variable.other.member.sql)
...
((term
   value: (cast
    name: (keyword_cast) @support.other.function.sql
    parameter: [(literal)]?)))
...
[
 ...
 (keyword_cost)
 (keyword_strict)
] @entity.other.attribute-name.sql
...
"(" @punctuation.definition.expression.begin.bracket.round.sql
")" @punctuation.definition.expression.end.bracket.round.sql

";" @punctuation.terminator.statement.sql
"," @punctuation.separator.comma.sql
"." @punctuation.separator.property.sql
